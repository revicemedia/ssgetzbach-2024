...
const features = [
  {
    ...
    description: [
      { id: 1, text: "Spiel- und Sportgemeinschaft Etzbach e.V." },
      { id: 2, text: "Drosselweg 9" },
      { id: 3, text: "57539 Etzbach" },
      { id: 4, text: "Vereinsregister: VR10252" },
      { id: 5, text: "Registergericht: Amtsgericht Montabaur" },
    ],
  ...
  },
  {
    name: "Kontakt",
    description: [
      { id: 1, text: "E-Mail: ssg-etzbach@web.de" },
      {
        id: 2,
  ...
  },
  {
    ...
    description: [
      { id: 1, text: "Julian Schröder" },
      { id: 2, text: "Sarah Gerhards" },
      { id: 3, text: "Janina Pattberg" },
      { id: 4, text: "Rolf Grün" },
    ],
    icon: UserCircleIcon,
  },
