...
const projects = [
    { name: 'Großsporthalle Hamm Sieg', initials: 'Mo', href: '#', members: "18:00 Uhr - 19:30 Uhr", bgColor: 'bg-red-500' },
    { name: 'Großsporthalle Hamm Sieg', initials: 'Do', href: '#', members: "19:15 Uhr - 20:45 Uhr", bgColor: 'bg-blue-600' },
  ]
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 overflow-hidden">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">1. Damen Mannschaft</h1>
