...
import { DevicePhoneMobileIcon, EnvelopeOpenIcon, PhoneArrowDownLeftIcon, PhoneXMarkIcon } from '@heroicons/react/24/outline'
...
//                   <li>
//                     <a href={person.phone} className="text-gray-400 hover:text-gray-500">
            ...
            {members.items.map((person: any) => (
                ...
                <div className="flex flex-1 flex-col p-8">
                    <div className="mx-auto h-32 w-32  rounded-full overflow-hidden">
                        <img className="object-cover min-h-full min-w-full" src={person.fields.foto.fields.file.url} alt="" />
                    </div>
                    <h3 className="mt-6 text-md font-regular text-gray-900">{person.fields.name}</h3>
                    <dl className="mt-1 flex flex-grow flex-col justify-between">
                    <dd className="text-sm text-gray-500">{person.fields.aufgabe}</dd>
                    </dl>
                </div>
                <div>
                    ...
                    {person.fields.eMail &&
                        <div className="flex w-0 flex-1 hover:bg-gray-50/50">
                            ...
                            >
                            <EnvelopeOpenIcon className="h-5 w-5 text-gray-700" aria-hidden="true" />
                            E-Mail
                            </a>
                        </div>
                    }
                    {person.fields.telefonnummer &&
                        <div className="-ml-px flex w-0 flex-1 hover:bg-gray-50/50">
                            ...
                            >
                            <PhoneArrowDownLeftIcon className="h-5 w-5 text-gray-700" aria-hidden="true" />
                            Anrufen
                            </a>
                        </div>
                    }
